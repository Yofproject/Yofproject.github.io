  ...
  <div class="main-container d-flex">
    <div class="sidebar" id="side_nav">
      ...
      <div id="content">
        ...
        <h3 class="h3">TAMBAH KAMAR</h3>
        </nav>

        <div class="card">
	<div class="card-header">
	<a href="sewa_kamar.php" class="btn btn-primary btn-icon-split">
      ...
      <div class="card-body">
        ...
        <select name="id_tipe_kamar" class = "form-control">
      ...
      <div class="form-group">
				...
				<input name="no_kamar" class="form-control" type="text" placeholder="Masukkan No Kamar" required><br>
			</div>
