  ...
  <div class="main-container d-flex">
    <div class="sidebar" id="side_nav">
      ...
      <div id="content">
        ...
        <h3 class="h3">TIPE KAMAR</h3>
        </nav>

        <div class="card">
	<div class="card-header">
	<a href="kamar.php" class="btn btn-primary btn-icon-split">
      ...
      <div class="card-body">
		<form method="post" action="proses_tipe_kamar.php">

			<div class="form-group">
				<label>Tipe Kamar</label>
				<input name="tipe_kamar" class="form-control" type="text" placeholder="Masukkan Tipe Kamar" required><br>
			</div>

            <div class="form-group">
				<label>Harga</label>
				<input name="harga_kamar" class="form-control" type="number" placeholder="Harga Kamar" required><br>
			</div>
