...
<html lang="en">
  ...
  <div class="main-container d-flex">
    <div class="sidebar" id="side_nav">
      ...
      <h3 class="h3">PROFIL MEMBER</h3>
      
      </nav>

      <div class="card" style="width: 18rem;">
  <img src="https://uxwing.com/wp-content/themes/uxwing/download/peoples-avatars/man-person-icon.png" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">Halo Admin Selamat Datang!!!</p>
  </div>
</div>
