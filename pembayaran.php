<?php 
    ...
    $id = $_GET["id_penyewa"];
    $penyewa = mysqli_query($koneksi, "SELECT * FROM tb_penyewa INNER JOIN tipe_kamar ON tipe_kamar.id_tipe_kamar = tb_penyewa.id_tipe_kamar INNER JOIN tb_kamar ON tb_kamar.id_kamar = tb_penyewa.id_kamar WHERE id_penyewa = '$id'");
    $row = mysqli_fetch_array($penyewa);
...
<html lang="en">
  ...
  <div class="main-container d-flex">
    <div class="sidebar" id="side_nav">
      ...
      <h3 class="h3">PEMBAYARAN KAMAR</h3>
      </nav>
      ...
      <div class="card-body">
        <form method="post" action="proses_bayar.php">
            ...
            <div class="form-group">
              ...
              <input name="nama_penyewa" class="form-control" type="text" placeholder="Masukkan Nama" value="<?php echo $row['nama_penyewa'];?>" required><br>
            </div>
            ...
            <div class="form-group">
              ...
              <input name="daerah_asal" class="form-control" type="text" placeholder="Masukkan Nama" value="<?php echo $row['daerah_asal'];?>" required disabled><br>
            </div>

            <div class="form-group">
              <label>Tanggal Lahir</label>
              <input name="tanggal_lahir" class="form-control" type="date" placeholder="Tanggal Lahir" value="<?php echo $row['tanggal_lahir'];?>" required disabled><br>
            </div>

            <div class="form-group">
              <label>Nomor HP</label>
              <input name="no_hp" class="form-control" type="text" maxlength="13"placeholder="Masukkan Nomor HP" value="<?php echo $row['no_hp'];?>" required disabled><br>
            </div>

            <div class="form-group">
              <label>Email</label>
              <input name="email" class="form-control" type="text" placeholder="Masukkan Email" value="<?php echo $row['email'];?>" required disabled><br>
            </div>
            ...
            <div class="form-group">
                ...
                <input name="tanggal_huni" class="form-control" type="date" placeholder="Tanggal Huni" value=" <?php echo $row['tanggal_huni'];?>" required><br>
            </div>

            <div class="form-group">
              <label>Tanggal Jatuh Tempo</label>
              <input name="tanggal_jatuh_tempo" class="form-control" type="date" placeholder="Tanggal Jatuh Tempo" required><br>
            </div>

            <div class="form-group">
              <label>Harga Kamar</label>
              <select name="harga_kamar" id="harga_kamar" class ="form-select">
                  <option value="<?php echo $row['harga_kamar'];?>">Rp. <?php echo $row['harga_kamar'];?></option>>
              </select>
            </div>
            <br>
            ...
            <div class="form-group">
              ...
              <input name="total" class="form-control" type="number" placeholder="Total Bayar" required><br>
            </div>
